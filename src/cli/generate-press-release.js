 ...
 * accessibility barriers found in today's daily HHS scan.
 *
...
const BASE_REPORT_URL = 'https://mgifford.github.io/daily-hhs/docs/reports/daily';
...
export function buildPressRelease(report, axeData, options = {}) {
  ...
  // Title
  lines.push(`# HHS Website Accessibility Report: ${humanDate(runDate)}`);
  lines.push('');
  ...
  lines.push(
    ...
    `most-visited HHS government websites found ${fmt(totalFindings)} accessibility ` +
  ...
  lines.push(
    ...
    'essential HHS government services. This is a single daily snapshot of the most popular ' +
    `~${fmt(processed)} pages in HHS web properties, as ranked by traffic data from ` +
    '[analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).'
  );
  lines.push('');
  ...
  lines.push('');
  lines.push(
    `Aggregate Lighthouse scores across ${fmt(succeeded)} scanned HHS government ` +
    'websites today:'
  );
  lines.push('');
  ...
  lines.push('');
  lines.push(
    'This report captures a daily snapshot of the most-visited HHS government web pages ' +
    'as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services), ' +
    'powered by the Digital Analytics Program (DAP). Scans use Lighthouse (Google\'s ' +
  ...
  lines.push('');
  lines.push(
    `*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | ` +
    `Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | ` +
