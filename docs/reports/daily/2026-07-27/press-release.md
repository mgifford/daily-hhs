...
# HHS Website Accessibility Report: July 27, 2026

*Washington, D.C. -- July 27, 2026* -- A daily scan of 19 of the most-visited HHS government websites found 29 accessibility barriers across 56 URLs today. The most common issues include Focus Order Predictability, Skip Link Functional Effectiveness, and Digital Motor Access.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,070,318 | ~23,547 |
| Without Vision | 1,060,805 | ~10,608 |
| Without Hearing | 1,060,805 | ~3,182 |
| Limited Reach and Strength | 12,645 | ~733 |
| Limited Vision | 7,641 | ~183 |
| Without Perception of Color | 2,364 | ~102 |

*Total page loads across all scanned URLs today: 1,150,059*
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-27/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-27/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-27/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-07-27*
