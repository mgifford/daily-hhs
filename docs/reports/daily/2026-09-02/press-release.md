...
# HHS Website Accessibility Report: September 2, 2026

*Washington, D.C. -- September 2, 2026* -- A daily scan of 1 of the most-visited HHS government websites found 3 accessibility barriers across 52 URLs today. The most common issues include Link Purpose Clarity, Skip Link Functional Effectiveness, and Focus Order Predictability.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 934,169 | ~20,552 |
| Without Vision | 934,169 | ~9,342 |
| Without Hearing | 934,169 | ~2,803 |

*Total page loads across all scanned URLs today: 934,169*
...
Aggregate Lighthouse scores across 1 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-09-02/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-09-02/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-09-02/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-09-02*
