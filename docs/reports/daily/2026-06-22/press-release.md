...
# HHS Website Accessibility Report: June 22, 2026

*Washington, D.C. -- June 22, 2026* -- A daily scan of 89 of the most-visited HHS government websites found 163 accessibility barriers across 89 URLs today. The most common issues include Digital Motor Access, Visual Information Access, and Primary Content Identification.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~89 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 2,704,904 | ~156,884 |
| Without Perception of Color | 2,612,962 | ~112,357 |
| Limited Manipulation | 3,317,566 | ~72,986 |
| Limited Vision | 2,617,238 | ~62,814 |
| Without Vision | 3,316,132 | ~33,161 |
| Without Hearing | 3,316,132 | ~9,948 |
| Limited Language, Cognitive, and Learning Abilities | 1,511 | ~71 |

*Total page loads across all scanned URLs today: 8,809,660*
...
Aggregate Lighthouse scores across 89 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 92.27 |
| Performance | 52.11 |
| Best Practices | 89.95 |
| SEO | 87.31 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-06-22/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-06-22/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-06-22/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-06-22*
