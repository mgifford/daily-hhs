...
# HHS Website Accessibility Report: April 30, 2026

*Washington, D.C. -- April 30, 2026* -- A daily scan of 36 of the most-visited HHS government websites found 66 accessibility barriers across 73 URLs today. The most common issues include Link Purpose Clarity, Primary Content Identification, and Focus Order Predictability.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,736,105 | ~38,194 |
| Limited Reach and Strength | 281,954 | ~16,353 |
| Without Vision | 1,460,084 | ~14,601 |
| Without Hearing | 1,460,084 | ~4,380 |
| Without Perception of Color | 58,685 | ~2,523 |
| Limited Vision | 64,171 | ~1,540 |
| Limited Language, Cognitive, and Learning Abilities | 351 | ~17 |

*Total page loads across all scanned URLs today: 2,024,273*
...
### 5. `target-size`: Digital Motor Access
...
Aggregate Lighthouse scores across 36 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-30/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-30/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-30/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-04-30*
