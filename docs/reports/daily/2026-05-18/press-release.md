...
# HHS Website Accessibility Report: May 18, 2026

*Washington, D.C. -- May 18, 2026* -- A daily scan of 86 of the most-visited HHS government websites found 157 accessibility barriers across 98 URLs today. The most common issues include Visual Information Access, Primary Content Identification, and Digital Motor Access.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~98 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 3,247,459 | ~188,353 |
| Without Perception of Color | 3,052,320 | ~131,250 |
| Limited Manipulation | 4,181,898 | ~92,002 |
| Limited Vision | 3,062,839 | ~73,508 |
| Without Vision | 4,181,518 | ~41,815 |
| Without Hearing | 4,181,518 | ~12,545 |
| Limited Language, Cognitive, and Learning Abilities | 2,351 | ~111 |

*Total page loads across all scanned URLs today: 10,586,279*
...
Aggregate Lighthouse scores across 86 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-18/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-18/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-18/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-05-18*
