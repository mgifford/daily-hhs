...
# HHS Website Accessibility Report: April 29, 2026

*Washington, D.C. -- April 29, 2026* -- A daily scan of 32 of the most-visited HHS government websites found 63 accessibility barriers across 70 URLs today. The most common issues include Primary Content Identification, Link Purpose Clarity, and Document Structure Navigation.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~70 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,494,462 | ~32,878 |
| Limited Reach and Strength | 284,019 | ~16,473 |
| Without Vision | 1,218,441 | ~12,184 |
| Without Hearing | 1,218,441 | ~3,655 |
| Without Perception of Color | 9,695 | ~417 |
| Limited Vision | 15,181 | ~364 |
| Limited Language, Cognitive, and Learning Abilities | 351 | ~17 |

*Total page loads across all scanned URLs today: 1,664,245*
...
### 5. `tabindex`: Focus Order Predictability
...
Aggregate Lighthouse scores across 32 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 88.33 |
| Performance | 58.96 |
| Best Practices | 89.13 |
| SEO | 88.63 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-29/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-29/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-29/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-04-29*
