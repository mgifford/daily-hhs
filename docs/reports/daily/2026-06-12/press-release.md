...
# HHS Website Accessibility Report: June 12, 2026

*Washington, D.C. -- June 12, 2026* -- A daily scan of 82 of the most-visited HHS government websites found 150 accessibility barriers across 82 URLs today. The most common issues include Primary Content Identification, Visual Information Access, and Digital Motor Access.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~82 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 4,445,454 | ~257,836 |
| Without Perception of Color | 4,348,347 | ~186,979 |
| Limited Manipulation | 5,064,450 | ~111,418 |
| Limited Vision | 4,358,382 | ~104,601 |
| Without Vision | 5,062,510 | ~50,625 |
| Without Hearing | 5,062,510 | ~15,188 |
| Limited Language, Cognitive, and Learning Abilities | 7,489 | ~352 |

*Total page loads across all scanned URLs today: 13,117,158*
...
Aggregate Lighthouse scores across 82 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-06-12/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-06-12/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-06-12/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-06-12*
