...
# HHS Website Accessibility Report: July 9, 2026

*Washington, D.C. -- July 9, 2026* -- A daily scan of 47 of the most-visited HHS government websites found 75 accessibility barriers across 79 URLs today. The most common issues include Primary Content Identification, Digital Motor Access, and Link Purpose Clarity.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~79 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,708,601 | ~37,589 |
| Without Vision | 1,680,200 | ~16,802 |
| Without Hearing | 1,680,200 | ~5,041 |
| Without Perception of Color | 86,208 | ~3,707 |
| Limited Vision | 97,939 | ~2,351 |
| Limited Reach and Strength | 40,226 | ~2,333 |
| Limited Language, Cognitive, and Learning Abilities | 394 | ~19 |

*Total page loads across all scanned URLs today: 2,055,381*
...
### 4. `tabindex`: Focus Order Predictability
...
Aggregate Lighthouse scores across 47 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-09/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-09/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-09/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-07-09*
