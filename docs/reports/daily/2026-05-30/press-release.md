...
# HHS Website Accessibility Report: May 30, 2026

*Washington, D.C. -- May 30, 2026* -- A daily scan of 140 of the most-visited HHS government websites found 247 accessibility barriers across 162 URLs today. The most common issues include Primary Content Identification, Digital Motor Access, and Visual Information Access.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 4,352,016 | ~252,417 |
| Without Perception of Color | 4,144,423 | ~178,210 |
| Limited Manipulation | 6,504,800 | ~143,106 |
| Limited Vision | 4,167,268 | ~100,014 |
| Without Vision | 6,465,792 | ~64,658 |
| Without Hearing | 6,465,792 | ~19,397 |
| Limited Language, Cognitive, and Learning Abilities | 9,069 | ~426 |

*Total page loads across all scanned URLs today: 16,948,460*
...
Aggregate Lighthouse scores across 140 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 92.08 |
| Performance | 55.36 |
| Best Practices | 90.67 |
| SEO | 88.13 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-30/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-30/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-30/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-05-30*
