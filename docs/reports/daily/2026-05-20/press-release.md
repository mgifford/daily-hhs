...
# HHS Website Accessibility Report: May 20, 2026

*Washington, D.C. -- May 20, 2026* -- A daily scan of 42 of the most-visited HHS government websites found 72 accessibility barriers across 68 URLs today. The most common issues include Primary Content Identification, Focus Order Predictability, and Link Purpose Clarity.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~68 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,671,246 | ~36,767 |
| Without Vision | 1,671,246 | ~16,712 |
| Without Hearing | 1,671,246 | ~5,014 |
| Without Perception of Color | 54,570 | ~2,347 |
| Limited Vision | 65,748 | ~1,578 |
| Limited Reach and Strength | 5,113 | ~297 |
| Limited Language, Cognitive, and Learning Abilities | 401 | ~19 |

*Total page loads across all scanned URLs today: 1,959,709*
...
Aggregate Lighthouse scores across 42 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 91.29 |
| Performance | 58.88 |
| Best Practices | 89.26 |
| SEO | 89.76 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-20/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-20/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-20/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-05-20*
