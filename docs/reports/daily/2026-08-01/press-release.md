...
# HHS Website Accessibility Report: August 1, 2026

*Washington, D.C. -- August 1, 2026* -- A daily scan of 35 of the most-visited HHS government websites found 66 accessibility barriers across 75 URLs today. The most common issues include Digital Motor Access, Focus Order Predictability, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,747,107 | ~38,436 |
| Without Vision | 1,720,289 | ~17,203 |
| Without Hearing | 1,720,289 | ~5,161 |
| Without Perception of Color | 75,776 | ~3,258 |
| Limited Vision | 81,125 | ~1,947 |
| Limited Reach and Strength | 33,052 | ~1,917 |
| Limited Language, Cognitive, and Learning Abilities | 343 | ~16 |

*Total page loads across all scanned URLs today: 2,132,305*
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-08-01/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-08-01/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-08-01/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-08-01*
