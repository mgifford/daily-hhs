...
# HHS Website Accessibility Report: July 17, 2026

*Washington, D.C. -- July 17, 2026* -- A daily scan of 98 of the most-visited HHS government websites found 163 accessibility barriers across 100 URLs today. The most common issues include Digital Motor Access, Primary Content Identification, and Document Structure Navigation.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~100 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 3,051,077 | ~176,962 |
| Without Perception of Color | 2,960,753 | ~127,312 |
| Limited Manipulation | 4,080,516 | ~89,771 |
| Limited Vision | 2,979,474 | ~71,507 |
| Without Vision | 2,309,738 | ~23,097 |
| Without Hearing | 2,309,738 | ~6,929 |
| Limited Language, Cognitive, and Learning Abilities | 8,399 | ~395 |

*Total page loads across all scanned URLs today: 12,610,786*
...
Aggregate Lighthouse scores across 98 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 92.8 |
| Performance | 55.15 |
| Best Practices | 90.73 |
| SEO | 86.91 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-17/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-17/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-07-17/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-07-17*
