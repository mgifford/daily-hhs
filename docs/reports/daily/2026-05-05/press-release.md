...
# HHS Website Accessibility Report: May 5, 2026

*Washington, D.C. -- May 5, 2026* -- A daily scan of 23 of the most-visited HHS government websites found 38 accessibility barriers across 57 URLs today. The most common issues include Focus Order Predictability, Link Purpose Clarity, and Skip Link Functional Effectiveness.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~57 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,108,917 | ~24,396 |
| Without Vision | 1,021,347 | ~10,213 |
| Limited Reach and Strength | 89,387 | ~5,184 |
| Without Hearing | 1,021,347 | ~3,064 |
| Without Perception of Color | 66,092 | ~2,842 |
| Limited Vision | 67,693 | ~1,625 |
| Limited Language, Cognitive, and Learning Abilities | 264 | ~12 |

*Total page loads across all scanned URLs today: 1,305,760*
...
Aggregate Lighthouse scores across 23 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 91.83 |
| Performance | 58.67 |
| Best Practices | 91.78 |
| SEO | 89.72 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-05/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-05/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-05/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-05-05*
