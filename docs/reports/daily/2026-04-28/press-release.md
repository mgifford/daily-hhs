...
# HHS Website Accessibility Report: April 28, 2026

*Washington, D.C. -- April 28, 2026* -- A daily scan of 27 of the most-visited HHS government websites found 47 accessibility barriers across 64 URLs today. The most common issues include Primary Content Identification, Link Purpose Clarity, and Skip Link Functional Effectiveness.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,198,084 | ~26,358 |
| Without Vision | 1,198,027 | ~11,980 |
| Without Hearing | 1,198,027 | ~3,594 |
| Without Perception of Color | 13,655 | ~587 |
| Limited Vision | 23,506 | ~564 |
| Limited Reach and Strength | 4,230 | ~245 |
| Limited Language, Cognitive, and Learning Abilities | 51 | ~2 |

*Total page loads across all scanned URLs today: 1,372,768*
...
### 3. `skip-link`: Skip Link Functional Effectiveness
...
Aggregate Lighthouse scores across 27 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-28/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-28/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-04-28/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-04-28*
