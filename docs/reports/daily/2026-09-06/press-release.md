...
# HHS Website Accessibility Report: September 6, 2026

*Washington, D.C. -- September 6, 2026* -- A daily scan of 81 of the most-visited HHS government websites found 158 accessibility barriers across 81 URLs today. The most common issues include Digital Motor Access, Primary Content Identification, and Visual Information Access.

These barriers prevent Americans with disabilities from independently accessing essential HHS government services. This is a single daily snapshot of the most popular ~81 pages in HHS web properties, as ranked by traffic data from [analytics.usa.gov](https://analytics.usa.gov/health-human-services) (powered by the Digital Analytics Program, DAP).
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 2,212,914 | ~128,349 |
| Without Perception of Color | 2,477,360 | ~106,526 |
| Limited Manipulation | 3,352,076 | ~73,746 |
| Limited Vision | 2,482,465 | ~59,579 |
| Without Vision | 2,049,742 | ~20,497 |
| Without Hearing | 2,049,742 | ~6,149 |
| Limited Language, Cognitive, and Learning Abilities | 1,764 | ~83 |

*Total page loads across all scanned URLs today: 10,775,238*
...
Aggregate Lighthouse scores across 81 scanned HHS government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 91.73 |
| Performance | 52.93 |
| Best Practices | 91.84 |
| SEO | 86.31 |
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-09-06/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-09-06/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-09-06/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-09-06*
