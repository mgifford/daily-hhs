...
# HHS Website Accessibility Report: May 28, 2026

*Washington, D.C. -- May 28, 2026* -- A daily scan of 34 of the most-visited HHS government websites found 63 accessibility barriers across 69 URLs today. The most common issues include Link Purpose Clarity, Focus Order Predictability, and Digital Motor Access.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 1,269,917 | ~27,938 |
| Without Vision | 1,242,414 | ~12,424 |
| Without Hearing | 1,242,414 | ~3,727 |
| Limited Reach and Strength | 28,270 | ~1,640 |
| Without Perception of Color | 11,572 | ~498 |
| Limited Vision | 12,431 | ~298 |

*Total page loads across all scanned URLs today: 1,419,250*
...
Aggregate Lighthouse scores across 34 scanned HHS government websites today:
...
- [View full interactive report](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-28/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-28/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-hhs/docs/reports/daily/2026-05-28/axe-findings.csv)

---

*Generated by [Daily HHS](https://github.com/mgifford/daily-hhs) | Source: [analytics.usa.gov/health-human-services](https://analytics.usa.gov/health-human-services) (Digital Analytics Program) | Methodology: Lighthouse + axe-core | Date: 2026-05-28*
